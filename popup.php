...
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
  ...
  <span class="size-box">
    ...
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-001"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-002"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-003"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-004"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-005"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-006"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-007"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-008"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-009"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-010"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-011"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-012"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-013"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-014"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-015"></i></a>
    <a href="javascript:emojiinsert('.png')"><i class="sprite sprite-016"></i></a>
  ...
  <section id="content1">
    ...
    <div class="emoji-grid">
      <a href="javascript:emojiinsert('.png')"><div class=""></div></a>
      <a href="javascript:emojiinsert('.png')"><div class=""></div></a>
      <a href="javascript:emojiinsert('.png')"><div class=""></div></a>
      <a href="javascript:emojiinsert('.png')"><div class=""></div></a>
      <a href="javascript:emojiinsert('.png')"><div class=""></div></a>
